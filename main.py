...
class PacketRequest(BaseModel):
    introductory_offer_selection: Optional[str] = ""

    carrier_client_code: Optional[str] = ""
...
def generate_packet(
    ...
    if payload.introductory_offer_selection.strip().upper() != "AD&D":
        return {
            "status": "skipped",
            "reason": "Introductory Offer Selection is not AD&D",
        }
...
def fill_pdf(payload: PacketRequest) -> str:
    ...
    field_values = {
        ...
        "type_of_business": payload.sic_description,
